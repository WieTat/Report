...
\lstset{
    ...
    numberstyle=\tiny,
    breaklines=true,
    backgroundcolor=\color{CorpColor},
...
\lstdefinelanguage{TypoScript}{
  ...
  keywordstyle=[1]{\color{CorpColor}\bfseries},
  keywords=[2]{plugin, view, page, file, text, config},
  keywordstyle=[2]{\color{CorpColor}\bfseries},
  keywords=[3]{EXT},
  keywordstyle=[3]{\color{CorpColor}\bfseries},
  sensitive=true,
  comment=[l]{\#\ }
}
...
% diese Farbdefinitionen zeichnen Links im PDF farblich aus
    linkcolor=CorpColor, % einfache interne Verknüpfungen
    anchorcolor=black,% Ankertext
    citecolor=CorpColor, % Verweise auf Literaturverzeichniseinträge im Text
    filecolor=CorpColor, % Verknüpfungen, die lokale Dateien öffnen
    menucolor=CorpColor, % Acrobat-Menüpunkte
    urlcolor=CorpColor, 
%
