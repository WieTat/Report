...
\par
In den Tabellen sind die Durchschnittswerte gem"ass dem \gls{EU}-\glsxtrshort{gmp}-Leitfaden dargestellt.
\par 
\vspace{1ex}
...
\begin{tabularx}{\textwidth}{p{4.5cm}XXp{4cm}}
	...
	\small{Messungen geführt:} & \underline{\hspace{3cm}}
		
	 & \multirow{3}{8cm}{\small{Geprüft und Genehmigt:}}& \\
...
\chapter{Messmittel und Proben} \label{cha:mittelPoben}
\section{Proben} \label{sec:Proben}

\begin{itemize}
\begin{Form}
	\item [1] \proben \quad {\ChoiceMenu[height=10pt,width=0.5cm, bordercolor={CorpColor},combo,default= 55mm]{Plate Count Agar $\diameter$}{55mm, 90mm}} \\[1.5ex]
	   \TextField[width=3cm, height=14pt, bordercolor={CorpColor}]{LOT:} \quad \TextField[width=2cm, height=14pt, bordercolor={CorpColor}]{Ablaufdatum: }\\[1.5ex]
	   \probeiso \qquad \beb\\[1.5ex]
	\item [2] proben \quad {\ChoiceMenu[height=10pt,width=0.5cm, bordercolor={CorpColor},combo,default= 55mm]{Plate Count Agar $\diameter$}{55mm, 90mm}} \\[1.5ex]
	\TextField[width=3cm, height=14pt, bordercolor={CorpColor}]{LOT:} \quad \TextField[width=2cm, height=14pt, bordercolor={CorpColor}]{Ablaufdatum: }\\[1.5ex]
	\probeiso \qquad \beb\\
\end{Form}
\end{itemize}
...
\begin{itemize}
	...
	\item [1] \TextField[width=2cm, height=14pt, bordercolor={CorpColor}]{Microbial Air Sampler, Type:} \quad
	          \TextField[width=3cm, height=14pt, bordercolor={CorpColor}]{Herrsteller: }\\[1.5ex]
	          \TextField[width=3cm, height=14pt, bordercolor={CorpColor}]{Serien Nr.:}\\[1.5ex]
	          \TextField[width=3cm, height=14pt, bordercolor={CorpColor}]{Kalibrierzertifikat Nr.:} \\[1.5ex]
	          \TextField[width=2cm, height=14pt, bordercolor={CorpColor}]{Kalibrierintervall.: } \quad \TextField[width=2cm, height=14pt, bordercolor={CorpColor}]{Kalibrierzertifikat gütlig bis: }\\
	        \end{Form}
\end{itemize} 
%caption{Messmittel}
...
{\ChoiceMenu[height=12pt,width=0.5cm, bordercolor={CorpColor},combo,default= 1]{Ahzahl Personsn im Raum}{1,2,3,4,5,6,7}}~{\ChoiceMenu[height=12pt,width=0.5cm, bordercolor={CorpColor},combo,default= 1]{davon}{1,2,3,4,5,6,7}}~Messtechniker.\\[1.5ex]
Hinweis: Alle Werte unterhalb von 0 (z. B. < 1, < 5) bedeuten, dass keine Keime nachweisbar sind.\\
	\resizebox{\columnwidth}{!}{%
	\begin{tabular}{|c|c|cc|cc|}
		\multicolumn{6}{l}{Luftproben}\\
		\hline
		                                &                               &                     \multicolumn{2}{c|}{}                      &            \multicolumn{2}{c|}{davon}            \\ \cline{5-6} 
		                                & \multirow{-2}{*}{Probenahme-} & \multicolumn{2}{c|}{\multirow{-2}{*}{aerob   mesophile Keime}} & \multicolumn{1}{c|}{Schimmelpilze} &   Sporen    \\ \cline{2-6}  
		\multirow{-3}{*}{Probenahmeort} &            Liter            & \multicolumn{1}{c|}{KBE/Platte} &        KBE/$m^3$       &  \multicolumn{1}{c|}{KBE/$m^3$}  & (KBE/$m^3$) \\ %\midrule
\hline
		             KL 1.1              &             1000              & \multicolumn{1}{c|}{\textless 1}  &        \textless 1         &  \multicolumn{1}{c|}{\textless 1}  & \textless 1 \\ 
\hline
		             KL 1.2              &             1000              &\textless 1  &        \textless 1         &  \multicolumn{1}{c|}{\textless 1}  & \textless 1 \\ 
\hline
		            \multicolumn{3}{|l|} {Mittelwert} & \textless 1 &\multicolumn{2}{c}{}\\
		             \cline{1-4}
	\end{tabular}%
	}
%\end{table
...
\resizebox{\columnwidth}{!}{%
	\begin{tabular}{|l|c|cc|}
		\multicolumn{4}{l}{Sedimentationsproben}                                                                                                          \\ \hline
		                                &                    \multicolumn{1}{c|}{}                     &            \multicolumn{2}{c|}{davon}            \\ \cline{3-4}
		\multirow{-2}{*}{Probenahmeort} & \multicolumn{1}{c|}{\multirow{-2}{*}{aerob mesophile Keime}} & \multicolumn{1}{c|}{Schimmelpilze} &   Sporen    \\ \cline
		{2-4}                           &                     KBE/4Stunden/Platte                      &   \multicolumn{1}{c|}{KBE/$m^3$}   &  KBE/$m^3$  \\ \hline
		...
		Mittelwert                      &                         \textless 1                          &               \multicolumn{2}{c}{}               \\ \cline{1-2}
	\end{tabular}%
}
...
\resizebox{\columnwidth}{!}{%
	\begin{tabular}{|l|c|c|c|}
		\multicolumn{4}{l}{Kontaktplatten}\\
		\hline
		
		\multirow{2}{*}{Probenahmeort}& \multirow{2}{*}{ Definition des Probenahmeortes} &  Gesamtkeimzahl aerob mesophile Keime &  davon   Schimmelpilze               \\ \cline{3-4} 
